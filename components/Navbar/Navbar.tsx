        ...
        <div className={classNames(defaultClasses, className)}>
            ...
            >
                <div className="flex items-center cursor-pointer hover:scale-105 transition-all" onClick={onLogoClick}>
                    <p className="font-conthrax font-[600] text-[28px] leading-[24px] text-primary">
                        RunesBridge
                    </p>
                ...
                <div
                    className={classNames(
                        "hidden w-1/2 lg:flex items-center justify-between",
                        subClass
                    )}
                >
            ...
            {isMenuOpened &&
                <div className="absolute top-[100%] left-0 z-10 w-full flex flex-col items-start gap-5 lg:hidden px-6 pt-9 bg-primary font-poppins font-[600] text-[14px] leading-[21px] text-white">
                    ...
                    <div className="px-2" onClick={() => scrollTo("welcome")}>V Say Welcome Home</div>
                    <div className="px-2" onClick={() => scrollTo("governance")}>CTO Governance</div>
                    <div className="px-2" onClick={() => scrollTo("airdrop")}>Airdrop Guild</div>
                    <div className="px-2" onClick={() => scrollTo("staking")}>Staking Forge</div>
                    <div className="px-2" onClick={() => scrollTo("bridge")}>Bridge</div>
                    <div className="px-2" onClick={() => scrollTo("governance2")}>RBV Governance</div>
                    <div className="px-2" onClick={() => scrollTo("task")}>Task Board/Suggesction</div>
                    <div className="px-2" onClick={() => scrollTo("token")}>RBV Token</div>
                    ...
                    <svg width="100%" height="100%" className="absolute top-0 left-0 -z-10" xmlns="http://www.w3.org/2000/svg">
                        <line x1="0%" y1="86%" x2="100%" y2="86%" stroke="#FFFFFF4D" strokeWidth={1} />
                        <line x1="90%" y1="0%" x2="90%" y2="100%" stroke="#FFFFFF4D" strokeWidth={0.8} />
                    </svg>
                </div>}
        </div>
    );
