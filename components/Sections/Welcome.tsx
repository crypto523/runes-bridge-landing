...
const Welcome: React.FC = () => {
    ...
    return (
        <SectionLayoutF>
            <div className="w-full h-full flex flex-col items-center px-[56px]">
                <div className="w-full flex flex-col items-end">
                    <h2 className="font-poppins font-[600] text-[48px] leading-[86px] text-center text-[#061012]">V says welcome home</h2>
                ...
                <div className="w-full flex items-center justify-center gap-4 mt-[4vw]">
                    ...
                    <div className="w-full h-full flex flex-col p-5 border-[1px] border-[#6262624D] bg-[#F6F5F54D]">
                        ...
                        <div className="w-full py-6 flex items-center justify-end pr-10">
                        ...
                        <div className="flex items-center gap-2 pl-5">
                            ...
                            <svg width="18" height="auto" viewBox="0 0 19 20" fill="none" xmlns="http://www.w3.org/2000/svg">
