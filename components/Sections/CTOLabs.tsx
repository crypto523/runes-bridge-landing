        ...
        <div className="w-full flex-1 flex items-center justify-around">
          ...
          <div className="max-w-[504px] ">
            ...
            <p className="text-[#444444] font-inter, font-[500] text-[16px] leading-[19.36px]">
              ...
              Key Opinion Leaders (KOLs) and we also have a growing suite of
              tech in the workshop for anyone to play with. We offer these tools
              as white label products and all the hands-on support needed for
              your project to launch and maintain successfully. <br />
              <br />
