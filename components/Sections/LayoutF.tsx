...
const SectionLayoutF: React.FC<LayoutProps> = ({
  children,
  className = "",
  currentSection,
  hideSection,
  ...
  return (
    <div
      className={`flex w-full h-full p-[30px_60px] overflow-hidden ${className}`}
    >
      <div ref={containerRef} className="relative w-full h-full">
        ...
        >
          ...
          />
          <polygon
            points={`${dimensions.width * 0.75},${dimensions.height * 1.02} ${
              dimensions.width * 0.7 - dimensions.height * 0.01
            },${dimensions.height * 0.91} ${dimensions.width * 0.05},${
              dimensions.height * 0.91
            } ${dimensions.width * 0.05},${dimensions.height * 1.02}`}
            fill="black"
          />
        </svg>
        ...
        <div className="absolute inset-0 w-full h-full flex flex-row-reverse z-20">
          <div className="w-[4.55%] h-full flex flex-col items-center justify-between border-[#626262] border-l-[1px] ">
            ...
            <div
              className="pb-[30px] w-full flex flex-col items-center cursor-pointer"
              onClick={() => {
                hideSection(currentSection);
          ...
          <div className="relative w-full h-full">
            <div
              className={`w-full h-full flex flex-col items-center transition-all ${
                isMenuOpened && "blur-md"
              }`}
            >
              <Navbar
                className="!px-5 !border-b-0"
                mainClass="flex-row-reverse"
                subClass="flex-row-reverse !justify-end gap-14"
              ...
              <div className="relative w-full h-[9vh] flex items-center justify-center pr-[303.5px] pl-[66px] -mb-[5px]">
                <div className="absolute top-[5vh] -translate-y-[50%] flex items-center justify-center gap-8">
                  ...
                  >
                    ...
                    />
                    <path
                      d="M30.0391 11.3304L29.7822 12.1813V36.8707L30.0391 37.1206L41.7888 30.3463L30.0391 11.3304Z"
                      fill="#061012"
                    />
                    <path
                      d="M30.0366 11.3304L18.2866 30.3463L30.0366 37.1206V25.1371V11.3304Z"
                      fill="#061012"
                    />
                    <path
                      d="M30.0393 39.2903L29.8945 39.4625V48.2572L30.0393 48.6694L41.7962 32.5196L30.0393 39.2903Z"
                      fill="#061012"
                    />
                    <path
                      d="M30.0366 48.6694V39.2903L18.2866 32.5196L30.0366 48.6694Z"
                      fill="#061012"
                    />
                    <path
                      d="M30.0352 37.1202L41.7849 30.3459L30.0352 25.1367V37.1202Z"
                      fill="#061012"
                    />
                    <path
                      d="M18.2866 30.3459L30.0366 37.1202V25.1367L18.2866 30.3459Z"
                      fill="#061012"
                    />
                  </svg>
                  <svg
                  ...
                  >
                    <circle cx="30" cy="30" r="30" fill="white" />
                    <path
                      d="M43.3332 39.3333V43.3333H16.6665V39.3333C16.6665 38.6 17.2665 38 17.9998 38H41.9998C42.7332 38 43.3332 38.6 43.3332 39.3333Z"
                      fill="black"
                      stroke="black"
                      strokeWidth="1.14286"
                      strokeMiterlimit="10"
                    ...
                    />
                    <path
                      d="M23.3332 28.6667H20.6665V38H23.3332V28.6667Z"
                      fill="black"
                    />
                    <path
                      d="M28.6667 28.6667H26V38H28.6667V28.6667Z"
                      fill="black"
                    />
                    <path
                      d="M34.0002 28.6667H31.3335V38H34.0002V28.6667Z"
                      fill="black"
                    />
                    <path
                      d="M39.3332 28.6667H36.6665V38H39.3332V28.6667Z"
                      fill="black"
                    />
                    <path
                      d="M44.6668 44.3333H15.3335C14.7868 44.3333 14.3335 43.88 14.3335 43.3333C14.3335 42.7867 14.7868 42.3333 15.3335 42.3333H44.6668C45.2135 42.3333 45.6668 42.7867 45.6668 43.3333C45.6668 43.88 45.2135 44.3333 44.6668 44.3333Z"
                      fill="black"
                    />
                    <path
                      d="M42.4932 21.6667L30.4932 16.8667C30.2265 16.76 29.7732 16.76 29.5065 16.8667L17.5065 21.6667C17.0398 21.8533 16.6665 22.4 16.6665 22.9067V27.3333C16.6665 28.0667 17.2665 28.6667 17.9998 28.6667H41.9998C42.7332 28.6667 43.3332 28.0667 43.3332 27.3333V22.9067C43.3332 22.4 42.9598 21.8533 42.4932 21.6667ZM29.9998 25.3333C28.8932 25.3333 27.9998 24.44 27.9998 23.3333C27.9998 22.2267 28.8932 21.3333 29.9998 21.3333C31.1065 21.3333 31.9998 22.2267 31.9998 23.3333C31.9998 24.44 31.1065 25.3333 29.9998 25.3333Z"
                      fill="black"
                    />
                  </svg>
                  <Image
