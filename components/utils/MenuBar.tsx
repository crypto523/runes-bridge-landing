...
const MenuBar: React.FC<MenuBarProps> = ({
    ...
    return (
        <div className={`absolute top-0 bottom-0 w-[47.5%] bg-[#061012] transition-all ${isOpened ? "flex flex-col items-center justify-around" : "hidden"} ${isRight ? "right-0" : "left-0"}`}>
